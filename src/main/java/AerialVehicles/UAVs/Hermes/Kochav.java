...
public class Kochav extends AerialVehicle implements AerialAttackVehicle, AerialIntelligenceVehicle, AerialBdaVehicle {
    ...
    public Kochav(int numberOfMissiles ,  String missilesType,String cameraType ,String sensorType,String pilotName ,   Mission mission, int flightHoursSinceLastPatch, boolean flightStatus ) {
    ...
    public String preformBda() {
        return this.pilotName + ": Kochav taking pictures of " + ((BdaMission) (this.mission)).getObjective() + " with: " +this.cameraType+" camera";
    }
